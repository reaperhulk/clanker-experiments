...
| AV1 decode | [rav1d](https://github.com/memorysafety/rav1d) | Rust port; default uses external assembly and has cc/nasm build dependencies and libc calls. Requires feature/source audit or a pure Rust variant before adoption; not assumed to meet the dependency requirement. |
