#!/usr/bin/env python3
"""Compare native HEVC samples; also report (never hide) default-output mismatch."""
import argparse
import hashlib
import json
...
def main():
    ...
    for index, fixture in enumerate(FIXTURES):
        ...
        outputs = {}
        for mode in ["reference_native", "reference_default", "candidate_native"]:
        ...
        record["default_output_match"] = "candidate_native" in outputs and "reference_default" in outputs and outputs["candidate_native"] == outputs["reference_default"]
