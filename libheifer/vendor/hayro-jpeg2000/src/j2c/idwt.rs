// Native normalization compatibility follows OpenJPEG; see LICENSE-OPENJPEG.
...
fn irreversible_filter_97i(scanline: &mut [f32], width: usize, x0: usize) {
    ...
    // Preserve OpenJPEG's historical inverse high-band normalization.
    const INV_KAPPA: f32 = 1.625_732_4;
