...
allocation accounting and object-specific resource lifetimes. Auxiliary/depth and item-property APIs follow, bringing the total to 144 partial
functions, with 321 functions missing. Compatibility work comes first;
