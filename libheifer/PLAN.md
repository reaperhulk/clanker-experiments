...
allocation accounting and object-specific resource lifetimes. Auxiliary/depth, item-property and six camera-matrix APIs bring the total to 150 partial
functions, with 315 functions missing. Compatibility work comes first;
