...
allocation accounting and object-specific resource lifetimes. Auxiliary/depth, item-property, six camera-matrix, twenty-two sensor-metadata and thirty-nine component APIs, generic items/compression, and twelve TAI timestamp APIs bring the total to
246 partial functions, with 219 functions missing. Compatibility work comes first;
