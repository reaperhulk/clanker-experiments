...
allocation accounting and object-specific resource lifetimes. Auxiliary/depth, item-property, six camera-matrix, twenty-two sensor-metadata and thirty-nine component APIs bring the total to 211 partial
functions, with 254 functions missing. Compatibility work comes first;
